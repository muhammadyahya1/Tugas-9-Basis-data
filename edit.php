...
$b = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM muhammadyahya_311910814 where nim='$_GET[id]'"));
...
if(isset($_POST['simpan'])){
 if(empty($nim)){    //jika nama kosong maka muncul pesan
    ...
    $save=mysqli_query($conn, "UPDATE muhammadyahya_311910814 set nim='$nim',nama_mhs='$nama_mhs',alamat_mhs='$alamat_mhs',jurusan_mhs='$jurusan_mhs',tgl_lahir='$tgl_lahir',IPK='$IPK' where nim='$_GET[id]'");
